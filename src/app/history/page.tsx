      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="space-y-1">
            { entry.type === 'task' && (
              <div>
                ...
                <div className="flex flex-wrap gap-1 mt-1.5">
                  <span className={ `text-[9px] font-black uppercase px-1.5 py-0.5 rounded ${ entry.priority === 'high' ? 'bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400' :
            ...
            { ( entry.food_notes || entry.train_notes || entry.study_notes || entry.mind_notes || entry.mind_description ) && (
      ...
      { selectedEntry && (
        ...
        >
          <div className="card w-full max-w-lg overflow-hidden shadow-2xl relative border-0 dark:border dark:border-slate-800 animate-fade-in" onClick={ ( e ) => e.stopPropagation() }>
            ...
            <div className={ `h-2 absolute top-0 left-0 right-0 ${ selectedEntry.log_module === 'nutrition' ? 'bg-emerald-500' :
                ...
                <div className="space-y-6">
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-slate-50 dark:bg-slate-800/20 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
                          ...
                          <span className={ `text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full ${ selectedEntry.priority === 'high' ? 'bg-rose-100 text-rose-600 dark:bg-rose-900/40 dark:text-rose-400' :
                  ...
                  { selectedEntry.log_module === 'mind' && (
                    <div>
                      ...
                      { ( selectedEntry.mind_title || selectedEntry.mind_description ) && (
                        <div className="mb-4">
                          { selectedEntry.mind_title && <h3 className="text-lg font-black text-slate-800 dark:text-slate-100 mb-1">{ selectedEntry.mind_title }</h3> }
                          { selectedEntry.mind_description && (
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={ e => setEditData( { ...editData, mind_title: e.target.value } ) }
                        />
                        ...
                        <textarea
                          ...
                          onChange={ e => setEditData( { ...editData, mind_description: e.target.value } ) }
                        />
