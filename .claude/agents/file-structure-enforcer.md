...
description: Apply when creating new components, hooks, services, features, or any new file in the project. Enforces folder structure, naming conventions, and barrel exports.
---
