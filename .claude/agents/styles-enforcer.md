...
description: Apply when writing or reviewing any JSX/TSX code. Enforces Tailwind CSS as the only styling method and prohibits inline styles and Styled Components.
---
