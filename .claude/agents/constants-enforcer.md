...
description: Apply when writing or reviewing any code that contains literal strings used as state/step/status values, or literal numbers used as limits, timeouts, rates, or thresholds. Enforces the use of named constants instead of magic values.
---
